...
export default async function AccommodationsPage() {
  ...
  if (error) {
    console.error("Konaklamalar alınamadı:", error);

    return (
      <section>
        <div className="border border-[#E7D6D1] bg-[#F8EEEA] px-5 py-12 text-center">
          <h2 className="text-sm font-semibold text-[#8A5147]">Konaklamalar yüklenemedi</h2>
  ...
  return <AccommodationsList accommodations={(accommodations ?? []) as Accommodation[]} />;
}
