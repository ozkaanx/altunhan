...
function getStatusClass(
  status: DashboardReservation["status"],
) {
  switch (status) {
...
export default async function AdminPage() {
  ...
  const activeAccommodationCount =
    accommodationsResult.count ??
    0;

  const totalReservationCount =
    reservationsResult.count ??
    0;
  ...
  const confirmedMonth =
    confirmedMonthResult.data ??
    [];

  const monthlyRevenue =
    confirmedMonth.reduce(
      (
        total,
        reservation,
      ) =>
  ...
  const statCards = [
...

    {
      ...
      value:
        activeAccommodationCount.toLocaleString(
          "tr-TR",
        ),
          ...
          <div className="space-y-3 p-4 sm:p-5">
            ...
            >
              ...
              <ChevronRight
                ...
                className="shrink-0 text-[#655D8A]"
              />
            </Link>
            ...
            >
              ...
              <ChevronRight
                ...
                className="shrink-0 text-[#526048]"
              />
            </Link>
...
function DashboardDetail({
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-[11px] font-medium text-[#4E544D]">
        {value}
      </p>
    </div>
  );
