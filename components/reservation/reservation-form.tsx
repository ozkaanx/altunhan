...
export function ReservationForm({
  ...
  async () => {
    ...
    try {
       ...
       * Bundan sonrası takip ekranının sorumluluğu.
       */
    ...
    <div className="mx-auto max-w-[760px]">
      <div className="border border-[#E1DED6] bg-white p-5 sm:p-8">
        ...
        <p className="mt-3 max-w-xl text-sm leading-6 text-[#70756F]">
          ...
          Odanız ödeme süreci için geçici
          olarak ayrıldı. Havale/EFT
        ...
        <div className="mt-7 grid gap-3 sm:grid-cols-2">
          ...
          <DetailCard
            label="Konaklama"
            value={
              createdReservation.accommodationTitle
            }
          />
        ...
        <div className="mt-7 border border-[#DDD9D1] bg-[#FAF8F4] p-4 sm:p-5">
          ...
          <div className="mt-4 border-t border-[#E5E1D9] pt-4">
            <p className="text-[11px] leading-5 text-[#777B74]">
        ...
        <div className="mt-7">
          ...
          <p className="mt-1 text-xs leading-5 text-[#8A8E88]">
            Ödemenizi yaptıktan sonra dekontunuzu
            yükleyin. JPG, PNG, WEBP veya PDF
            kabul edilir. Maksimum 10 MB.
          </p>
          ...
          <label className="mt-4 flex min-h-32 cursor-pointer flex-col items-center justify-center border border-dashed border-[#CBC7BE] bg-[#FAF9F6] p-4 text-center transition hover:border-[#A8754F]">
            ...
            <p className="mt-1 text-[10px] text-[#969990]">
              Telefonunuzdan fotoğraf veya PDF
              seçebilirsiniz.
            </p>
          ...
          {receipt && (
            <div className="mt-3 flex items-center justify-between gap-3 border border-[#E4E1D9] bg-[#F7F6F2] px-3 py-3">
              ...
              <button
                ...
                className="shrink-0 text-[10px] font-semibold text-[#98584E]"
              >
                Kaldır
              </button>
            </div>
        ...
        <div className="mt-6 border-t border-[#EEEAE3] pt-5">
          <p className="text-center text-[10px] leading-5 text-[#969990]">
            Dekontunuz gönderildikten sonra
            rezervasyon takip ekranına
