  ...
  return (
    <section className="border border-[#DDD8CC] bg-[#FAF8F2] p-4 sm:p-6">
      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="flex items-start gap-3 bg-[#F0F2EC] px-4 py-3">
          <ShieldCheck size={15} strokeWidth={1.5} className="mt-0.5 shrink-0 text-[#526048]" />

          <p className="text-[9px] leading-5 text-[#747A72]">
...
function InputShell({
  ...
  return (
    <div className="mt-2 flex h-[52px] items-center border border-[#D9D5CD] bg-white transition-colors focus-within:border-[#263A2D]">
      <div className="flex h-full w-12 shrink-0 items-center justify-center border-r border-[#EEEAE3] text-[#A8754F]">
