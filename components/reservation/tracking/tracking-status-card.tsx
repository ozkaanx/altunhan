...
> = {
  ...
  cancelled: {
    ...
    description: "Rezervasyonunuz iptal edildi. Aşağıda iptal açıklamasını görebilirsiniz.",
  },
  ...
  pending_approval: {
    ...
    description: "Dekontunuz bize ulaştı. Rezervasyonunuz yönetici onayı bekliyor.",
  },
...
export function TrackingStatusCard({ status }: TrackingStatusCardProps) {
  ...
  return (
    <div className={`flex min-w-0 items-start gap-3 border p-4 ${config.className}`}>
