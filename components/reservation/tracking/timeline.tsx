  ...
  return (
    <div className="relative flex gap-4">
      <div className="relative flex shrink-0 flex-col items-center">
        ...
        {!isLast && (
          <div
            className={`min-h-10 w-px flex-1 ${config.lineClassName}`}
          />
        )}
      </div>
      ...
      >
        <p
          className={`text-xs font-semibold ${config.titleClassName}`}
        >
          {step.title}
        </p>

        <p className="mt-1 text-[11px] leading-5 text-[#858A83]">
          {
            step.description
          }
        </p>
