        ...
        <div className="grid gap-6 px-5 py-6 sm:px-7 sm:py-7 lg:grid-cols-[auto_1fr] lg:items-start lg:gap-7 lg:px-8">
          <div>
            ...
            <p className="mt-4 text-[13px] leading-7 text-[#5F665F] sm:text-sm">
              Beach&apos;te misafirlerimizin rahat ve keyifli bir ortamda vakit geçirebilmesi
              amacıyla, özellikle grup girişlerinde kadın–erkek oranı dikkate alınmaktadır.
              Girişler; gün içerisindeki yoğunluk, kapasite ve mevcut denge göz önünde
