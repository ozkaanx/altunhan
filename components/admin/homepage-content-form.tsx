...
import { updateHomepageContent } from "@/app/admin/homepage/action";

import type { HomepageContent, HomepageContentFormValues } from "@/types/homepage-content";
...
export function HomepageContentForm({ content }: HomepageContentFormProps) {
  const [form, setForm] = useState<HomepageContentFormValues>({
    ...
    experienceTitle: content.experience_title,

    experienceDescription: content.experience_description,

    feature1Title: content.feature_1_title,

    feature1Description: content.feature_1_description,

    feature2Title: content.feature_2_title,

    feature2Description: content.feature_2_description,

    feature3Title: content.feature_3_title,

    feature3Description: content.feature_3_description,

    accommodationLabel: content.accommodation_label,

    accommodationTitle: content.accommodation_title,

    accommodationDescription: content.accommodation_description,

    locationLabel: content.location_label,

    locationTitle: content.location_title,

    reviewsLabel: content.reviews_label,

    reviewsTitle: content.reviews_title,

    footerLabel: content.footer_label,

    footerTitle: content.footer_title,
  ...
  function updateField<K extends keyof HomepageContentFormValues>(
    key: K,
  ...
  return (
    <div className="space-y-6">
      <ContentSection title="Hero" description="Ana sayfanın ilk büyük alanındaki metinler.">
        <TextField
          label="Üst Etiket"
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <FeatureFields
            title="Özellik 1"
            fieldTitle={form.feature1Title}
            description={form.feature1Description}
            onTitleChange={(value) => updateField("feature1Title", value)}
            onDescriptionChange={(value) => updateField("feature1Description", value)}
          />

          <FeatureFields
            title="Özellik 2"
            fieldTitle={form.feature2Title}
            description={form.feature2Description}
            onTitleChange={(value) => updateField("feature2Title", value)}
            onDescriptionChange={(value) => updateField("feature2Description", value)}
          />

          <FeatureFields
            title="Özellik 3"
            fieldTitle={form.feature3Title}
            description={form.feature3Description}
            onTitleChange={(value) => updateField("feature3Title", value)}
            onDescriptionChange={(value) => updateField("feature3Description", value)}
          />
        </div>
      </ContentSection>
      ...
      >
        <TextField
          label="Etiket"
          value={form.accommodationLabel}
          onChange={(value) => updateField("accommodationLabel", value)}
        />

        <TextField
          label="Başlık"
          value={form.accommodationTitle}
          onChange={(value) => updateField("accommodationTitle", value)}
        />

        <TextareaField
          label="Açıklama"
          value={form.accommodationDescription}
          onChange={(value) => updateField("accommodationDescription", value)}
        />
      </ContentSection>
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-4">
            <TextField
              label="Yorum Etiketi"
              value={form.reviewsLabel}
              onChange={(value) => updateField("reviewsLabel", value)}
            />
      ...
      >
        <TextField
          ...
          onChange={(value) => updateField("footerLabel", value)}
        />
        ...
        <TextareaField
          ...
          onChange={(value) => updateField("footerDescription", value)}
        />
      </ContentSection>
  ...
  return (
    <section className="border border-[#E3E0D8] bg-white p-5 sm:p-6">
      <div className="border-b border-[#ECE8E1] pb-4">
        ...
        <p className="mt-1 text-[11px] leading-5 text-[#92968E]">{description}</p>
      </div>
...
function FeatureFields({
  ...
  return (
    <div className="border border-[#ECE8E1] bg-[#FAF9F6] p-4">
      ...
      <div className="space-y-4">
        <TextField label="Başlık" value={fieldTitle} onChange={onTitleChange} />

        <TextareaField label="Açıklama" value={description} onChange={onDescriptionChange} />
      </div>
    </div>
  );
}
