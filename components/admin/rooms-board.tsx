    ...
    <>
      ...
      <div className="mt-5 flex flex-col gap-3 border border-[#E3E0D8] bg-white p-4 lg:flex-row lg:items-center">
        <select
          ...
          className="h-11 w-full border border-[#DDD9D1] bg-[#FAF9F6] px-3 text-sm text-[#263A2D] outline-none lg:max-w-[280px]"
        >
          <option value="all">
            Tüm oda tipleri
          </option>
...
function StatCard({
  ...
  return (
    <div className="border border-[#E3E0D8] bg-white p-4">
      ...
      <p className="mt-3 text-3xl font-semibold text-[#263A2D]">
        {value}
      </p>
    </div>
  );
