        ...
        <div className="mt-7 grid gap-2.5 sm:grid-cols-2">
          {amenityItems.map((amenity) => {
            ...
            return (
              <div
                key={amenity}
                className="group flex min-h-[58px] items-center gap-3.5 border border-[#DDD8CC] bg-[#FAF8F2] px-3.5 py-2.5 transition-colors hover:border-[#C9B08A] hover:bg-[#F7F2E8]"
              >
                <div className="flex h-9 w-9 shrink-0 items-center justify-center bg-[#E9EDE6] text-[#526048] transition-colors group-hover:bg-[#E2E8DE]">
                  <Icon size={16} strokeWidth={1.5} />
                </div>

                <span className="text-[11px] font-medium leading-5 text-[#4E554E] sm:text-xs">
                  {amenityMeta.label}
                </span>
              </div>
            );
